                        ...
                        <div class="col-md-12">
                          <div class="home-box-content">
                            <div class="left-text">
                              ...
                              <p>The Following is  the List of book based on your choices. It is selected by finding nearest matches to your selected books.</p>
...
$sql = "SELECT * FROM book_det where title in(".$ids.")";
...
sort($genrearray); 
   ...
   $sql = "SELECT * FROM book_det where rating>".$min_rating." and rating_count>".$min_vc." and genres like '%".$res."%' and genres like '%".$res2."%' ORDER BY RAND()  LIMIT 15;";
