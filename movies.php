...
<form method="get"> 
  <table>
    <tr>
      <td>
 Film Industry</td><td><select id ="Mv_Ind" class="select_panel">
...
<tr>
 ...
 Your Favorite Genre</td>
 <td><select id="genre" class="select_panel">
...
<td>
Rating above</td>
<td><select id="rating" class="select_panel">
    <?php
        $i=1;
         while($i<=10)
         {
...
Vote Count above</td>
<td><select id="votes" class="select_panel">
...
<div id="wrapper">
  Or.. 
<div class="heading"><h4>Select Your Favorite Movies to see simmilar ones</h4></div>
<br />
<div id="MovieList" style="overflow: auto;height:250px;">
...
$sql = "SELECT * FROM movie_det where voter_average>5 and vote_count> 800 ORDER BY RAND() LIMIT 15;";
...
<div class='ListItems' value=".$row["id"]."><img src='".$matches[1][20]."' alt='".$row["title"]."' width='120' height='140' style='padding-bottom:0.5em;' /><br />".$row["title"]."</div>
</li>";
    }
} else {
    echo "Not Found";
